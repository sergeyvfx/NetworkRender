"""
Renderer.py common functions for rendering (local and remote) of stills and parts.

It defines a single class Renderer that implements sending a .blend file if needed,
retrieving results and some support functions. It does NOT implement the actual
rendering of parts or frames (see L{Network.AnimRenderThread} and L{Network.StillRenderThread})
